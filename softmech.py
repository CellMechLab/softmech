...
import protocols.cpoint
import protocols.fmodels
import protocols.emodels
...
class NanoWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ALLPLOTS = [self.ui.g_fz_all, self.ui.g_fz_single, self.ui.g_fizi_all, self.ui.g_fizi_single,
                         self.ui.g_eze_all, self.ui.g_eze_single, self.ui.g_scatter1, self.ui.g_scatter2]
    ...
    def loadExperiment(self):
        fOpener = QtWidgets.QFileDialog.getOpenFileName(
            self, "Open Experiment File", self.workingpath, "JSON curve files (*.json)")
        ...
        for c in engine.dataset:
            ...
            if cp is not None:
                ...
                if (ret is not None) and (ret is not False):
                    ...
                    c.calc_elspectra(int(self.ui.es_win.value()), int(
                        self.ui.es_order.value()), bool(self.ui.es_interpolate.isChecked()))
