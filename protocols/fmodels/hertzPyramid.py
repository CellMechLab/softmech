...
NAME = 'Hertz Pyramid' #Name, please keep it short as it will appear in the combo box of the user interface
DESCRIPTION = 'Fit indentation data with the Hertz model - 4 sided Pyramid indenter' #Free text
...
class FModel(fitPanel):
    ...
    def theory(self,x,*parameters):
        if self.curve.tip['geometry']=='pyramid':
